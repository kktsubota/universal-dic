# modified from  https://github.com/Googolxx/STF/blob/main/compressai/models/cnn.py
...
from aof.layers.attn_blocks import Win_noShift_Attention, Win_noShift_Attention_Adapter
